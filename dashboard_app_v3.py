...
#     # Display table with selected columns
#     display_cols = ['SR.No.', 'Date of Report Generation','Employee ID','Employee Name','Cost Center','Attrition Prediction', 'Attrition Probability', 
#                    'Risk Level', 'Tenure Bucket (Today Based)','Triggers', 'HR_Comments', 'OPS_comments','Regrettable Y/N']
    
#     # Format the table
#     table_df['Date of Report Generation'] = pd.to_datetime(table_df['Date of Report Generation']).dt.strftime('%Y-%m-%d %H:%M:%S')
...
#                 width="large"
#             ),
#             "Regrettable": st.column_config.TextColumn(
#                 "Regrettable",
#                 help="Is this attrition regrettable?",
#                 width="small"
#             ),
...
#                     current_df.loc[mask, 'HR_Comments'] = row['HR_Comments']
#                     current_df.loc[mask, 'OPS_comments'] = row['OPS_comments']
#                     current_df.loc[mask, 'Regrettable'] = row['Regrettable']
...
#                     # Convert timestamp to string format before saving
#                     current_df['Date of Report Generation'] = current_df['Date of Report Generation'].dt.strftime('%Y-%m-%d %H:%M:%S')
